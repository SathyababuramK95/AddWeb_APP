...
exports.registerUser = async(req,res)=>{
    try {
        let usersDataWithSameUsername = await User.findOne({ username : req.body.username}).exec();
        ...
        newUser.email = req.body.emailid && req.body.emailid || null;
...
exports.loginUser = (req,res)=>{
    ...
    let email = req.body.emailid && req.body.emailid || null; 
    ...
    if(userData){
        ...
        JsonWebToken.sign(userData.username,jwt_secret_key,{},(error,sessionToken)=>{
            ...
            newLoginSession.save((err,sessionData)=>{
                ...
                Utils.sendSuccessResponse({ sessionData : sessionData,userData : userData, token : sessionToken },res);
                return;
            });
        });
